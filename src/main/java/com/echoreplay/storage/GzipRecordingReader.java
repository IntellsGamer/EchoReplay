...
public final class GzipRecordingReader {
    ...
    public List<com.echoreplay.model.TimelineEvent> timeline() {
        List<com.echoreplay.model.TimelineEvent> out = new ArrayList<>();
        ...
        out.sort(java.util.Comparator.comparingLong(com.echoreplay.model.TimelineEvent::tickMillis));
        return out;
    }
